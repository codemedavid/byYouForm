  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      const settings: SiteSettings = {
        site_name: settingsData.find(s => s.id === 'site_name')?.value || 'byYOUFORM',
        ...
        hero_description: settingsData.find(s => s.id === 'hero_description')?.value || 'byYOUFORM offers precision-formulated peptide solutions, designed for individuals who demand nothing less than excellence in their personal wellness journey.',
