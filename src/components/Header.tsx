          ...
          <div className="flex items-center justify-between gap-4">
            ...
            >
              <div className="relative flex-shrink-0">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 shadow-lg flex items-center justify-center group-hover:shadow-xl transition-all overflow-hidden border-[3px] border-white ring-2 ring-blue-400">
                  <img 
                    src="/logo.jpg" 
                    alt="Peptivate.ph" 
                ...
                <div className="absolute -top-1 -right-1 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full p-1.5 shadow-md">
                  <Sparkles className="w-3 h-3 md:w-3.5 md:h-3.5 text-white" />
                </div>
              </div>
              <div className="text-left min-w-0 flex-1">
                <h1 className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold bg-gradient-to-r from-blue-600 via-blue-700 to-blue-900 bg-clip-text text-transparent leading-tight whitespace-nowrap overflow-hidden text-ellipsis">
                  Peptivate.ph
                </h1>
                <p className="text-[10px] sm:text-xs md:text-sm lg:text-base text-gray-600 font-medium flex items-center gap-1">
                  <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 text-blue-500 flex-shrink-0" />
